// Forked from https://github.com/sindresorhus/type-fest/blob/main/source/package-json.d.ts
    ...
    funding?:
      ...
      | {
          /**
			The type of funding.
			*/
          type?: 'github' | 'opencollective' | 'patreon' | 'individual' | 'foundation' | 'corporation' | string
...
@category File
*/
type PackageJson = PackageJson.NodeJsStandard &
